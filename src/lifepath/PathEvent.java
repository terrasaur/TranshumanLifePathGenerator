...
public class PathEvent {
	...
	// This will eventually be a better data structure
	// The Path Event should hold one or more things that the Character object
	// should be able to use to update its fields, such as skills or aptitude bonuses.
	...
	public static ArrayList<PathEvent> getFallEvent(Integer roll) {
		ArrayList<PathEvent> evList = new ArrayList<PathEvent>(); 
		PathEvent ev = VariableRollObject.findResult(PathEvent.fallEvent, roll);
		ev.timeline = "Fall";
		evList.add(ev);
		if (ev.action == ActionType.getStoryEvent){
			//Die d100 = new Die(100);
	...
	public static ArrayList<PathEvent> getPostFallEvent(Integer roll) {
		ArrayList<PathEvent> evList = new ArrayList<PathEvent>(); 
		PathEvent ev = VariableRollObject.findResult(PathEvent.postFallEvent, roll);
		ev.timeline = "Post-Fall";
		evList.add(ev);
		if (ev.action == ActionType.gatecrashing){
			Die d100 = new Die(100);
			ev = VariableRollObject.findResult(PathEvent.gatecrashingEvent, d100.Roll());
	...
	public static PathEvent getFirewallEvent(Integer roll) {
		PathEvent ev = VariableRollObject.findResult(PathEvent.firewallEvent, roll);
	...
	static 	{
		...
		backgroundEvent.add(new VariableRollObject<PathEvent>(93, 94, 
		...
		backgroundEvent.add(new VariableRollObject<PathEvent>(95, 96, 
				new PathEvent("Tormented by bullies as a kid, you learn to stand up for yourself.", ActionType.addSkill, 10, "Unarmed Combat")));
		backgroundEvent.add(new VariableRollObject<PathEvent>(97, 98, 
		...
		backgroundEvent.add(new VariableRollObject<PathEvent>(99, 100, 
		...
		preFallEvent.add(new VariableRollObject<PathEvent>(1,  20, 
				new PathEvent("Story Event.", ActionType.getStoryEvent, 1, "MOX")));
		preFallEvent.add(new VariableRollObject<PathEvent>(21, 22, 
				new PathEvent("You save an animal from danger.", ActionType.addTrait, "Animal Empathy")));
		preFallEvent.add(new VariableRollObject<PathEvent>(23, 24, 
				new PathEvent("You take up a sport.", "+10 to Climbing, Fray, Free Fall, Freerunning, or Swimming")));
		preFallEvent.add(new VariableRollObject<PathEvent>(25, 26, 
		...
		preFallEvent.add(new VariableRollObject<PathEvent>(27, 28, 
		...
		preFallEvent.add(new VariableRollObject<PathEvent>(53, 54, 
		...
		preFallEvent.add(new VariableRollObject<PathEvent>(67, 68, 
		...
		preFallEvent.add(new VariableRollObject<PathEvent>(69, 70, 
		...
		preFallEvent.add(new VariableRollObject<PathEvent>(87, 88, 
		...
		preFallEvent.add(new VariableRollObject<PathEvent>(89, 90, 
		...
		preFallEvent.add(new VariableRollObject<PathEvent>(91, 92, 
		...
		preFallEvent.add(new VariableRollObject<PathEvent>(93, 94, 
		...
		preFallEvent.add(new VariableRollObject<PathEvent>(95, 96, 
				new PathEvent("You start up an unusual hobby.", "Gain +20 to one Exotic Melee Weapon or Exotic Ranged Weapon skill")));
		preFallEvent.add(new VariableRollObject<PathEvent>(97, 98, 
		...
		fallEvent.add(new VariableRollObject<PathEvent>(11, 12, 
				new PathEvent("You stay to the end, fighting a rear-guard action.", ActionType.newMorph, "Any", "Gain +1 Moxie")));
		fallEvent.add(new VariableRollObject<PathEvent>(13, 14, 
		...
		fallEvent.add(new VariableRollObject<PathEvent>(15, 16, 
				new PathEvent("You exemplify yourself in destroying TITAN machines.", ActionType.overrideFocus, "Wrecker")));
		fallEvent.add(new VariableRollObject<PathEvent>(17, 18, 
		...
		fallEvent.add(new VariableRollObject<PathEvent>(19, 20, 
		...
		fallEvent.add(new VariableRollObject<PathEvent>(39, 40, 
		...
		fallEvent.add(new VariableRollObject<PathEvent>(41, 42, 
		...
		fallEvent.add(new VariableRollObject<PathEvent>(53, 54, 
		...
		fallEvent.add(new VariableRollObject<PathEvent>(61, 62, 
		...
		fallEvent.add(new VariableRollObject<PathEvent>(63, 64, 
		...
		fallEvent.add(new VariableRollObject<PathEvent>(71, 72, 
				new PathEvent("Several near-death experiences hone your reflexes.", ActionType.modifyAptitude, 5, "REF")));
		fallEvent.add(new VariableRollObject<PathEvent>(73, 74, 
		...
		fallEvent.add(new VariableRollObject<PathEvent>(75, 76, 
		...
		fallEvent.add(new VariableRollObject<PathEvent>(77, 78, 
				new PathEvent("You exhibit natural leadership in a time of crisis.", "Gain +10 to Persuasion or Intimidation")));
		fallEvent.add(new VariableRollObject<PathEvent>(79, 80, 
		...
		fallEvent.add(new VariableRollObject<PathEvent>(81, 82, 
		...
		fallEvent.add(new VariableRollObject<PathEvent>(83, 84, 
		...
		fallEvent.add(new VariableRollObject<PathEvent>(85, 86, 
		...
		fallEvent.add(new VariableRollObject<PathEvent>(87, 88, 
		...
		fallEvent.add(new VariableRollObject<PathEvent>(89, 90, 
		...
		fallEvent.add(new VariableRollObject<PathEvent>(91, 92, 
				new PathEvent("You lose a fortune during the Fall.", ActionType.modifyCredits, -10000)));
		fallEvent.add(new VariableRollObject<PathEvent>(93, 94, 
		...
		fallEvent.add(new VariableRollObject<PathEvent>(95, 96, 
		...
		postFallEvent.add(new VariableRollObject<PathEvent>(1, 3, 
		...
		postFallEvent.add(new VariableRollObject<PathEvent>(4, 
				new PathEvent("You reinvent yourself.", "Gain +5 to one aptitude and –5 to another aptitude")));
		postFallEvent.add(new VariableRollObject<PathEvent>(5, 6,
		...
		postFallEvent.add(new VariableRollObject<PathEvent>(7, 
		...
		postFallEvent.add(new VariableRollObject<PathEvent>(11, 13, 
		...
		postFallEvent.add(new VariableRollObject<PathEvent>(14, 
		...
		postFallEvent.add(new VariableRollObject<PathEvent>(15, 
		...
		postFallEvent.add(new VariableRollObject<PathEvent>(16, 
				new PathEvent("You use the post-Fall chaos to establish a new identity.", "Gain a Fake Ego ID for free")));
		postFallEvent.add(new VariableRollObject<PathEvent>(17, 
		...
		postFallEvent.add(new VariableRollObject<PathEvent>(18, 
		...
		postFallEvent.add(new VariableRollObject<PathEvent>(19, 
		...
		postFallEvent.add(new VariableRollObject<PathEvent>(22, 24, 
		...
		postFallEvent.add(new VariableRollObject<PathEvent>(25, 
		...
		postFallEvent.add(new VariableRollObject<PathEvent>(26, 
		...
		postFallEvent.add(new VariableRollObject<PathEvent>(46, 
		...
		postFallEvent.add(new VariableRollObject<PathEvent>(62 , 
				new PathEvent("You commit a serious crime, but get away—for now.", ActionType.addTrait, "On the Run")));
		postFallEvent.add(new VariableRollObject<PathEvent>(63, 65, 
		...
		postFallEvent.add(new VariableRollObject<PathEvent>(70 , 
				new PathEvent("You decide you need some help.", ActionType.addTrait, "Established Fork")));
		postFallEvent.add(new VariableRollObject<PathEvent>(71 , 
		...
		postFallEvent.add(new VariableRollObject<PathEvent>(72 , 
		...
		postFallEvent.add(new VariableRollObject<PathEvent>(73 , 
				new PathEvent("Doing your part to aid transhumanity's regrowth, you have a kid.", ActionType.addTrait, "Dependent")));
		postFallEvent.add(new VariableRollObject<PathEvent>(74 , 
		...
		postFallEvent.add(new VariableRollObject<PathEvent>(78 , 
				new PathEvent("You take in an abandoned animal.", "Gain a smart dog, smart monkey, or smart rat for free")));
		postFallEvent.add(new VariableRollObject<PathEvent>(79 , 
		...
		postFallEvent.add(new VariableRollObject<PathEvent>(80 , 
		...
		postFallEvent.add(new VariableRollObject<PathEvent>(81 , 
		...
		postFallEvent.add(new VariableRollObject<PathEvent>(82 , 
		...
		postFallEvent.add(new VariableRollObject<PathEvent>(89 , 
		...
		postFallEvent.add(new VariableRollObject<PathEvent>(90, 
		...
		postFallEvent.add(new VariableRollObject<PathEvent>(91, 
		...
		postFallEvent.add(new VariableRollObject<PathEvent>(92, 
				new PathEvent("You fall in with a new crowd—one that will have your back.", ActionType.addTrait, "Allies")));
		postFallEvent.add(new VariableRollObject<PathEvent>(93, 
		...
		postFallEvent.add(new VariableRollObject<PathEvent>(94, 
				new PathEvent("You join a cooperative project.", ActionType.addTrait, "Entrepreneur (Level 1)")));
		postFallEvent.add(new VariableRollObject<PathEvent>(95, 
		...
		postFallEvent.add(new VariableRollObject<PathEvent>(96, 
		...
		gatecrashingEvent.add(new VariableRollObject<PathEvent>(21, 48, 
		...
		gatecrashingEvent.add(new VariableRollObject<PathEvent>(49, 50, 
		...
		gatecrashingEvent.add(new VariableRollObject<PathEvent>(51, 52, 
		...
		gatecrashingEvent.add(new VariableRollObject<PathEvent>(53, 54, 
				new PathEvent("You receive some focused training in gate operations.", "Gain the Infosec (Gate Hacking) specialization")));
		gatecrashingEvent.add(new VariableRollObject<PathEvent>(55, 56, 
		...
		gatecrashingEvent.add(new VariableRollObject<PathEvent>(77, 78, 
		...
		gatecrashingEvent.add(new VariableRollObject<PathEvent>(79, 80, 
		...
		gatecrashingEvent.add(new VariableRollObject<PathEvent>(81, 82, 
		...
		firewallEvent.add(new VariableRollObject<PathEvent>(49, 50 , 
		...
		firewallEvent.add(new VariableRollObject<PathEvent>(51, 52 , 
		...
		firewallEvent.add(new VariableRollObject<PathEvent>(53, 54 , 
		...
		firewallEvent.add(new VariableRollObject<PathEvent>(55, 56 , 
		...
		firewallEvent.add(new VariableRollObject<PathEvent>(57, 58 , 
		...
		firewallEvent.add(new VariableRollObject<PathEvent>(59, 60 , 
		...
		firewallEvent.add(new VariableRollObject<PathEvent>(69, 70 , 
		...
		firewallEvent.add(new VariableRollObject<PathEvent>(81, 82 , 
		...
		firewallEvent.add(new VariableRollObject<PathEvent>(83, 84 , 
				new PathEvent("You uncover a sleeper exsurgent cell the hard way.", ActionType.addTrait, "Phobia Disorder (Exsurgents)")));
		firewallEvent.add(new VariableRollObject<PathEvent>(85, 86 , 
		...
		firewallEvent.add(new VariableRollObject<PathEvent>(87, 88 , 
		...
		firewallEvent.add(new VariableRollObject<PathEvent>(89, 90 ,
		...
		firewallEvent.add(new VariableRollObject<PathEvent>(91, 92 , 
		...
		firewallEvent.add(new VariableRollObject<PathEvent>(93, 94 , 
				new PathEvent("You are a bit too good at ferreting out certain secrets online. Firewall brings you in to the fold to keep your mouth shut.",
						ActionType.addSkill, 10, "Infosec")));
		firewallEvent.add(new VariableRollObject<PathEvent>(95, 96 , 
		...
		firewallEvent.add(new VariableRollObject<PathEvent>(97, 98 , 
		...
		firewallEvent.add(new VariableRollObject<PathEvent>(99, 100 , 
